...
def main():
    ...
    end_lat, end_lon = -41.300061, 1.075436  # Replace with the actual end coordinates
    num_waypoints = 19  # Replace with the desired number of waypoints
    ...
    csv_filename = 'PSO\shady/waypoints.csv'
