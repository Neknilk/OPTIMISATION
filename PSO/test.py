...
def wrapper_function():
    pso(initial_coord, final_coord, altitude, day, num_waypoints, num_particles, num_iterations, speed_meters_per_second)
...
# time_taken = calculate_time(best_waypoints, speed_meters_per_second)# # Save waypoints as a CSV file with burned fuel and time information
