...
# Example usage
initial_coord = np.array([41.236991296008284, -8.674928937639095]) 
final_coord = np.array([32.735331891484115, -117.20266163942416])
altitude = 1  # for weather data
day = 3  # for weather data
num_waypoints = 30
num_particles = 100
num_iterations = 30
...
csv_path = os.path.join(csv_directory, "OPO-SD.csv")
